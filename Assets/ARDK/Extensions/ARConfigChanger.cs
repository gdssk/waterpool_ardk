...
namespace Niantic.ARDK.Extensions
{
  ...
  {
    private _ARConfigChangesCollector _changesCollector;
    ...
    private void SetConfigChangesCollector(AnyARSessionInitializedArgs args)
    {
      ...
      _changesCollector = arSession._ARConfigChangesCollector;
      _changesCollector.Register(this);

      // The session's _ARConfigChangesCollector is destroyed when the session is disposed.
    ...
    internal abstract void _ApplyARConfigurationChange(IARConfiguration config);
  }
}
