    ...
    _IEditorMultipeerSessionMediator
  {
    ...
    private sealed class _MultipeerHelper
    {
      ...
      )
      {
        ...
        networking.Disconnecting += _Disconnecting;
      ...
      internal void _Dispose()
      {
        ...
        _networking.Disconnecting -= _Disconnecting;
      ...
      private void _Disconnecting(DisconnectingArgs args)
      {
    ...
    public _MockMultipeerNetworking CreateNonLocalSession(Guid stageIdentifier, ARInfoSource source)
    {
      var networking =
