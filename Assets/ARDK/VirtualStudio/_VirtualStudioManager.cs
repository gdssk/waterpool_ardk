...
namespace Niantic.ARDK.VirtualStudio
{
    ...
    _IVirtualStudioManager
  {
    ...
    public void InitializeAllProfiles(MockPlayConfiguration playConfiguration)
    {
    ...
    private bool InitializeProfile(MockArdkPlayerProfile playerProfile)
    {
      ...
      if (playerProfile.UsingNetwork)
      {
        ...
        var networking =
          _multipeerMediator.CreateNonLocalSession(stageIdentifier, playerProfile._ARInfoSource);
      ...
      {
        var arSession =
          _arSessionMediator.CreateNonLocalSession(stageIdentifier, playerProfile._ARInfoSource);
