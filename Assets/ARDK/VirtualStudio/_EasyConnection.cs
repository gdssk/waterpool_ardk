...
namespace Niantic.ARDK.VirtualStudio.Remote
{
  ...
  internal static class _EasyConnection
  {
    ...
    // As this class depends on RenoteConnection, we must call Initialize() after RemoteConnection
    ...
    private static void _MessageReceived(MessageEventArgs args)
    {
      ...
      var data = args.data;
      if (data == null)
        throw new ArgumentException("args.data is null.", "args");

      object message = data.DeserializeFromArray<object>();
      if (message == null)
        throw new ArgumentException("args had a null message. That shouldn't happen.", "args");
    ...
    public static IDisposable Register<T>(Action<T> messageExecutor)
    {
      ...
      if (messageExecutor == null)
        throw new ArgumentNullException("messageExecutor");
      ...
      throw new ArgumentException(message, "messageExecutor");
    }
    ...
    public static void Send(object message)
    {
      ...
      _RemoteConnection.Send(_easyConnectionMessageId, bytes);
    }
