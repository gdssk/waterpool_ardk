...
namespace Niantic.ARDK.VirtualStudio.Remote
{
  ...
  /// <summary>
  /// Extensions for <see cref="_IRemoteConnectionCompat"/>
  /// </summary>
  internal static class _RemoteConnectionCompatExt
  {
    /// <summary>
    /// Sends a generic struct using SerializeToArray.
    /// </summary>
    public static void Send<TValue>
    (
      this _IRemoteConnectionCompat remoteConnectionCompat,
      Guid tag,
      TValue value
    )
    {
      remoteConnectionCompat.Send(tag, value.SerializeToArray());
    }
  }
}
