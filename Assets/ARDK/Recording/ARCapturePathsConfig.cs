...
namespace Niantic.ARDK.Recording
{
  ...
  public struct ARCapturePathsConfig
  {
    /// <summary>
    ...
    /// <summary>
    /// Creates an ARCapturePathsConfig, with helpers to provide defaults.
    /// </summary>
    ...
    public ARCapturePathsConfig(string workingPath = null, string archivePath = null)
    {
      WorkingDirectoryPath = workingPath;
      ArchivePath = archivePath;
    }

    public static ARCapturePathsConfig Default
    {
      get
      {
