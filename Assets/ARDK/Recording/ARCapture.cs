...
namespace Niantic.ARDK.Recording
{
    ...
    IDisposable
  {
    ...
    /// </summary>
    public void Start(ARCapturePathsConfig pathsConfig)
    {
      PInvoke.Start(_nativeHandle, pathsConfig);
    }
    ...
    /// </summary>
    public ARCapturePathsConfig GetCapturePaths()
    {
      if (IsRecording())
      {
      ...
      return ARCapturePathsConfig.Default;
    }
    ...
    private static class PInvoke
    {
      ...
      /// <param name="pathsConfig">The config object containing paths to working directory and archive file.</param>
      public static void Start(HandleRef nativeHandle, ARCapturePathsConfig pathsConfig)
      {
#if AR_NATIVE_SUPPORT
        _NARCapture_Start(nativeHandle.Handle, pathsConfig);
#endif
      }
      ...
      /// </summary>
      public static ARCapturePathsConfig GetPaths(HandleRef nativeHandle)
      {
#if AR_NATIVE_SUPPORT
        int bufferSize = 512;
        ...
        return new ARCapturePathsConfig
        {
      ...
      [DllImport(_ARDKLibrary.libraryName)]
      private static extern void _NARCapture_Start(IntPtr nativeHandle, ARCapturePathsConfig pathsConfig);
