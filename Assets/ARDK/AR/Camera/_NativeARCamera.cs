...
namespace Niantic.ARDK.AR.Camera
{
    ...
    IARCamera
  {
    ...
    private _NativeARCamera(IntPtr nativeHandle, float worldScale)
    {
    ...
    public Matrix4x4 Intrinsics
    {
      get
      {
        ...
        var intrinsics = _Convert.Internal3x3ToMatrix4x4(nativeIntrinsics);
        return intrinsics;
      }
    }

    public Matrix4x4 CPUIntrinsics
    {
      get
      {
        var nativeIntrinsics = new float[16];
