...
namespace Niantic.ARDK.AR.Configuration
{
  ...
  internal sealed class _ARConfigChangesCollector
  {
    private _IARSession _arSession;

    private Action<IARConfiguration> _configChangesRequested;

    private bool _observerRequestedCollection;

    private IARConfiguration _preChangeConfiguration;

    internal _ARConfigChangesCollector(_IARSession arSession)
    {
    ...
    internal void _CollectChanges(IARConfiguration arConfiguration)
    {
      ...
      _configChangesRequested?.Invoke(arConfiguration);
    ...
    public void Register(ARConfigChanger changer)
    {
      ...
      _configChangesRequested += changer._ApplyARConfigurationChange;
    ...
    private void RerunIfRequested()
    {
      if (_observerRequestedCollection && _arSession != null)
      {
        ...
        _arSession.Run(configCopy, _arSession.RunOptions);
      }
    }
  }
}
