  ...
  public static class GlobalSerializer
  {
    ...
    )
    {
      ...
      if (untypedItemSerializer == null)
      {
        ...
        throw new ArgumentException(msg, "itemSerializer");
      }
    ...
    {
      if (untypedItemSerializer == null)
        throw new ArgumentNullException("untypedItemSerializer");

      var dataType = untypedItemSerializer.DataType;
      if (dataType == null)
        throw new ArgumentException("Serializer DataType is null.", "untypedItemSerializer");
